...
public class DisplayFeaturesDcDimScheduleActivity extends CollapsingToolbarBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .replace(R.id.content_frame, new DisplayFeaturesDcDimScheduleFragment())
                    .commit();
        }
    }
    ...
    public static class DisplayFeaturesDcDimScheduleFragment extends PreferenceFragment implements
            Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {

        private static final String TAG = "DisplayFeaturesDcDimScheduleFragment";
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            setPreferencesFromResource(R.xml.dc_dimming_schedule_settings, rootKey);
        ...
        private void updateTimeSummary(String[] times, int mode) {
            ...
            if (mode == MODE_NIGHT) {
                mSincePref.setSummary(R.string.dc_dimming_schedule_sunset);
                mTillPref.setSummary(R.string.dc_dimming_schedule_sunrise);
                return;
            }
